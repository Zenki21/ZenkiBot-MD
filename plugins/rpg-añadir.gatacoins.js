...
money += pjk
if (money < 1) throw `${mg}𝙀𝙇 𝙉𝙐𝙈𝙀𝙍𝙊 𝙈𝙄𝙉𝙄𝙈𝙊 𝘿𝙀 𝙕𝙀𝙉𝙆𝙄𝘾𝙊𝙄𝙉𝙎 𝙀𝙎 *1*\n\n𝙏𝙃𝙀 𝙈𝙄𝙉𝙄𝙈𝙐𝙈 𝙉𝙐𝙈𝘽𝙀𝙍 𝙁𝙍𝙊𝙈 𝙕𝙀𝙉𝙆𝙄𝘾𝙊𝙄𝙉𝙎 𝙄𝙎 *1*`
...
//▢  *𝚃𝚘𝚝𝚊𝚕:* ${xp}
//└──────────────`)
conn.sendHydrated(m.chat, `╭━━━[ 𝙕𝙀𝙉𝙆𝙄𝘾𝙊𝙄𝙉𝙎 🐈 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${gatacoins} GataCoin(s)* 🐈\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝙕𝙚𝙣𝙠𝙞𝘽𝙤𝙩-𝙈𝘿', null, null, [
